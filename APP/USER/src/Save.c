...
/*********************************************************************************
 ...
 Others:        //
*********************************************************************************/
void Read_TPB21_ErrorRecord(void)          
{
  TPB21.ErrorRecord = *((const unsigned char *)(TPB21_ERROR_RECORD_ADD));
}
/*********************************************************************************
 Function:      //
 Description:   //保存TPB21错误记录
 Input:         //
                //
 Output:        //
 Return:	//
 Others:        // 
*********************************************************************************/
void Save_TPB21_ErrorRecord(void)    
{
  WriteRom(TPB21_ERROR_RECORD_ADD,&TPB21.ErrorRecord,1);
}
